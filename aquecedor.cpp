 ...
 *			Código do Atuador Aquecedor
 *			Vitor Avian nUSP: 10295392
 **/

/**
 *		Descrição:
 *			Código que simula a comunicação do atuador Aquecedor com o
...
int main(int argc, char *argv[]) {
	...
	while (true) {
		...
		if(funcao == 1){ // Ligar o aquecedor e informar o gerenciador o que fez
			cout<<"Ligando aquecedor..."<<endl;
			send(sockfd, "Aquecedor ligado.", 17, 0);
		}
		else if(funcao == 0){ // Desligar o aquecedor
			cout<<"Desligando aquecedor..."<<endl;
			send(sockfd, "Aquecedor desligado.", 20, 0);
		}
		else
			break;
