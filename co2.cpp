 ...
 *	  	   	Código do Sensor de CO2
 *		   Vitor Avian nUSP: 10295392
 **/

/**
 *		Descrição:
 *			Código que simula a comunicação do sensor de CO2 com o
 *		Gerenciador, ao se conectar, o sensor informa ao gerenciador
 *		a ultima leitura do nível de CO2.
 **/
...
// Função para simular uma leitura de CO2 randomica
void ultimaLeitura(){
	int temp1, temp2;
	temp1 = rand() % 9;
	temp2 = rand() % 10;
...
int main(int argc, char *argv[]) {
	...
	while (true) {
		...
		if(responder == '1'){
			cout<<"Lendo o nível de CO2... "<<endl;
			ultimaLeitura();
			strcpy(buffer_out, co2);
			cout<<co2<<endl;
